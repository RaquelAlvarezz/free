...
define('PHPGRID_DB_USERNAME','Harrypotter');     // database user name
define('PHPGRID_DB_PASSWORD','Hogwarts'); // database password
define('PHPGRID_DB_NAME','free'); // database name
