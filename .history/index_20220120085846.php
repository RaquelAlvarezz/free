...
<style>
body {
  background: linear-gradient(to top, rgba(0, 0, 0, 0.698) 0%, rgba(0, 0, 0, 0.637) 45%, rgba(0,0,0,0.65) 100%),  url(https://images.pexels.com/photos/3183153/pexels-photo-3183153.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940) no-repeat;
}
.centered {
    margin: 0;
    position: absolute;
